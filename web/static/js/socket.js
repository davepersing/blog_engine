...
/**
 * NOTE:  For some reason, brunch doesn't pick up devDependencies in the package.json.
 * Because of this, I had to install jquery by using:
 *  npm install jquery --save NOT npm install jquery --save-dev
 */
import $ from "jquery";
